...
namespace LoginServer.Migrations
{
    ...
    [Migration("20240817155723_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LoginServer.DB.ItemDb", b =>
                {
            ...
            modelBuilder.Entity("LoginServer.DB.PlayerDb", b =>
                {
            ...
            modelBuilder.Entity("LoginServer.DB.ServerDb", b =>
                {
            ...
            modelBuilder.Entity("LoginServer.DB.ItemDb", b =>
                {
                    b.HasOne("LoginServer.DB.PlayerDb", "Owner")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("LoginServer.DB.PlayerDb", b =>
                {
                    b.HasOne("LoginServer.DB.AccountDb", "Account")
                        .WithMany("Players")
